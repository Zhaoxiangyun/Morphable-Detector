...
class FsodDataset(torchvision.datasets.coco.CocoDetection):
    def __init__(
        self, ann_file, root, remove_images_without_annotations, transforms=None
    ):
        super(FsodDataset, self).__init__(root, ann_file)
       ...
       # f = open('fsod_test_categories.txt','w')
    ...
    def __getitem__(self, idx):
        img, anno = super(FsodDataset, self).__getitem__(idx)
