...
class ROIBoxHead(torch.nn.Module):
    ...
    def forward(self, features, proposals,targets=None,ignore_labels=None, testing=False, previous_logits=None, get_det=False, weighting= False):
        """
        Arguments:
        ...
        # final classifier that converts the features into 
        ...
        if get_det:
            ...
            result = self.post_processor((class_logits, box_regression), proposals, labels=[1,3])
            return x, result, {}
