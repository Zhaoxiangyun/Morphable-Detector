...
class PostProcessor(nn.Module):
    ...
    def __init__(
        ...
        self.score_thresh_1 = 0.6
        self.score_thresh_2 = 0.1
...
# TODO think about a representation of batch of boxes
    ...
    def filter_results(self, boxlist, num_classes, labels=None):
        ...
        if labels is not None:
             inds_all = scores > self.score_thresh_1
             inds_ignore_1 = scores < self.score_thresh_1
             inds_ignore_2 = scores > self.score_thresh_2
