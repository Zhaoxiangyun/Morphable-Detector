...
"""
Implements the Genegalized R-CNN framework
"""
            ...
            if not ignore_labels:
                if not self.training:
                   ...
                   if not self.seperate:
                     ...
                     x, result, detector_losses2 = self.head_list[0](features, proposals_list[0], targets=targets, targets2=result_all)
# igniore labels
        else:
